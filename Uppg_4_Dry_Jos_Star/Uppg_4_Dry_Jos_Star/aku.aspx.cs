...
{
    public partial class aku : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // metoden ligger i DatabaseConnections 
            DatabaseConnection db = new DatabaseConnection();
            List<Person> personer2 = db.GetNoTestPersonsAku();
        ...
        {
            GridView11.DataSource = people;
            GridView11.DataBind();
        }

        protected void GridView11_RowDataBound1(object sender, GridViewRowEventArgs e)
        {
